...
This study adopted several data collection techniques, namely, interviews, an observation, and speculative co-design sessions. This approach was crucial for this study to (1) understand how therapists reason about their agency in relation to AI-supported systems for exergame-based rehabilitation and how it should be configured between them across the four main phases of rehabilitation (See @phases), and (2) design implications to potentially direct future researchers and product designers on how therapists' preference for shared agency could be implemented (See @designimplications).



=== Contextual Inquiry A - Interviews
This study's explorations started with a contextual inquiry @Holtzblatt2015 through semi-structured interviews with the company’s Product Manager (PM) and MD/Founder to understand the products, the workflow, and the underlying reasoning and logic behind the rehabilitation products. Semi-structured interviews were also conducted with three OTs who have used either one or both of Brain Stimulation's digital services (RehAtt® DiSTRO and RehAtt® XR) to understand their workflow, appreciations and pain points with the tools @myers2013. All five interviews were designed to last a maximum of 45-60 minutes long. 
...
We employed speculative co-design sessions within a participatory RtD approach, inviting participants to a design-futuring space @Smith2025. The sessions were structured around four situated and specific futures through which, desirable agency configurations and concerns in rehabilitation systems were explored (See @codesign). A total of six individual speculative co-design sessions were conducted with OTs, PTs, and researchers within the rehabilitation field (see @codesign), of which, the first session was a pilot study which was conducted to adjust and improve the activities, questions, and overall quality of the co-design session. All six co-design sessions were designed to last between 1.5 to 2 hours. 

==== Pilot Study
The pilot study was informed by the case study, literature, and contextual inquiries with Brain Stimulation informants and their therapists (end-users) and was conducted with one participant (P6). For the pilot study, a persona was created to ground the session in a realistic clinical setting to provide a context, which the participant could refer to for the duration of the session (See Appendix @persona).

In the pilot study, the participant was presented with seven futuristic and provocative rehabilitation system scenarios (See Appendix @pilotstudyscenarios) to probe the therapists' agency boundaries with the system, and the requirements for fine-grained settings and exergame parameters in different phases of rehabilitation. The scenarios were selected to highlight the four dimensions listed below which were considered important to therapists' sense of agency, surfacing from previous research and the contextual inquiry (@section:contextualinquiry). 
...
*Adjustment 5:* With _Agency in Reasoning_ and _Agency in Execution_ being the primary dimensions, the remaining dimensions served as a means to further probe and isolate findings. A 2x2 scenario matrix was created for the primary dimensions, ranging from full human agency to full system agency, and then scenarios were developed for each combination to explore agency shift across the spectrum and independently examine the dimensions (See @codesign). To further probe the agency distribution in each of the scenarios, questions were formulated for the secondary dimensions. This allowed the study to shift from abstract thinking about scenarios based on randomized dimensions to, in a controlled manner, be open to critical conversation about possible futures.
...
The redesigned final co-design session aimed to understand the sense of agency in relation to the system, and how the agential cut should be drawn across the rehabilitation process through the generated dimensions. Similar to the pilot study, the participants were also first presented with a persona (See @persona) that grounded the entire co-design session in clinical practice. Then, they were also introduced to the four main phases of rehabilitation (See @phases) and subsequently validated with them. These phases were set as standard for the entirety of the session to have a common language. The participants were then, presented with four scenarios developed from the 2x2 scenario matrix which were based on the two primary dimensions _Agency in Reasoning_ and _Agency in Execution_. The scenarios were presented and probed one after the other starting with Scenario 1 followed by Scenario 2, Scenario 3, and finally Scenario 4 (See @codesign). The scenarios were created to reflect on agency distribution for each individual combination of primary dimensions in the scenario matrix (See @table-scenarios). Each scenario was then constructed to embody its assigned agency distribution. The scenarios presented during the co-design session are as follows: 
...
== Participants
The participants were deliberately selected through a purposive sampling method where only individuals who attained one or several of the following criteria's were invited: (1) Works or has worked as a clinical occupational therapist, (2) Works or has worked as a clinical physiotherapist, (3) PhD students, professors and/or researchers within occupational therapy, physiotherapy and/or rehabilitation field. These requirements were essential in both attaining a contextual inquiry and qualitative data from the co-design session @Ahmad2024. This method ensured that the collected data would be relevant to the aims of this study while providing in-depth insights which were crucial for conceptualizing therapists' preferences for agency and its distribution across the four phases of rehabilitation @phases. Several networks were used to recruit therapists and/or researchers fulfilling the mentioned criteria. Those networks were direct users (OTs & PTs) of Brain Stimulation's services, researchers at Umeå University, and LinkedIn. The snowball sampling method was also used, where recommendations for additional contacts with similar criteria was requested from all those who were contacted @myers2013. In total 40 individuals who fall within our criteria were invited, of which 8 agreed to participate in one or several of this study's sessions (See @table-participants). 
...
After all data was gathered, we performed a bottom-up approach through affinity diagramming which allowed the themes and concepts to emerge from within the data rather than from some pre-imposed theories and concepts @myers2013 @dmtbr2020. The affinity diagramming method was applied on this study's contextual inquiry and co-design sessions separately because they have two different agendas. The contextual inquiry was solely to get a contextual understanding of Brain Stimulation products, current exergame-based rehabilitation process, existing constraints and issues, which later informed the design decisions of the pilot study and co-design sessions. While the co-design sessions, were to determine more concretely how therapists from various fields reason about their agency in relation to AI-supported systems for exergame-based rehabilitation, and its configuration across the main phases of rehabilitation. The findings from the pilot study was not included in the final data analysis of the speculative co-design sessions as it was only used to adjust the design of the final co-design session activity.
...
This study involves therapists and a non-interfering observation of usage of Brain Stimulation's digital products (RehAtt® DiSTRO and RehAtt® XR) during a rehabilitation session, which can raise ethical considerations regarding informed consent, privacy and data handling. The observation was hence only conducted after explicit verbal consent from both the therapist and the patient and no other data, such as patient data or patient condition, beyond the therapist-patient interaction was collected. All interviews and co-design sessions were also only conducted and recorded after all participants had provided explicit verbal consent. The recordings were later transcribed, controlled and corrected using Teams for validity purposes. All recordings and transcripts were stored in a secure university-sanctioned Microsoft account in accordance with their data protection guidelines. Additionally, because this study does not involve collection of sensitive data, participants were comfortable providing verbal consent instead of written consent. Naturally, participants also had the opportunity to withdraw their consent and participation in the study at any time. 
