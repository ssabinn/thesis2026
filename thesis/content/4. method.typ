...
This study involves therapists and involves non-interfering observation of usage of Brain Stimulation's digital products (RehAtt® DiSTRO and RehAtt® XR) during a rehabilitation session, which can raise ethical considerations regarding informed consent, privacy and data handling. *The observation was hence only conducted after explicit verbal consent from both the therapist and the patient and no other data, such as patient info or patient condition, beyond the therapist-patient interaction was collected.* All interviews and co-design sessions were also only conducted and recorded after all participants had provided explicit verbal consent. The recordings were later transcribed, controlled and corrected using Teams for validity purposes. All recordings and transcripts were stored in secure university-sanctioned Microsoft account in accordance with their data protection guidelines. Additionally, because this study does not involve collection of sensitive data, participants were comfortable providing verbal consent instead of written consent. Naturally, participants also had the opportunity to withdraw their consent and participation in the study at any time. 
