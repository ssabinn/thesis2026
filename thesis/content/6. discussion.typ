...
- when that agency is given to the system it creates an overreliance which might inadvertently affect their own clinical reasoning and decision-making skills - this could be destructive to novice therapists (source AI make you dumber)
 ...
 Overall, the sense of agency in a AI-supported exergame-based rehabilitation system was an indispensable element for the participants as it supports them in delivering adaptive and effective therapy to their patients. The underlying reasons to this perception was however mixed and highly dependent on time and effort extorted by the therapist. One the one hand, participants felt comfortable of letting go of control/agency to the system due to the workload demands and limited time resources within their rehabilitation field/settings. On the other hand, majority of participants expressed feelings of threat, that they could be undermined or possibly substituted by the AI if the work process were to be fully automated, even if they could intervene and override when necessary. Simultaneously, the full automated system was still picked more than the system with full human agency despite participants wanting to remain in control. These results aligns with (*source*) which *also* found that the sense of agency decreases with both high mental workload and higher level of automation. Hence, the reasonable/sensible outcome of our results indicating the need for shared agency through hybrid control between the therapist and the system.
 
 Remaining in control and not being fully substituted by the system was also argued to be vital in fostering a good and trusting patient-relationship. This was said to lead to create adherence and motivation to actually perform rehabilitation consistently which corresponds to (TA source which says that). Furthermore, our results are also consistent with those reported by *(source)* on how therapists take subjective data into account more than the objective data. This was very evident by the therapists choice to time and time again pick meeting the patient over additional objective data provided by the system. *(Talk about how talking with humans is the cause of this with SOURCE).* //can you instill that adherence through the system itself? - also connect to how looking and meeting the patient was much more important than looking at the data alone. 
 // explain that if one does it correctly, our participants would be willing to trust the system to perform the rehabilitation if it does not compromise ethical or security measures. 
...
In early phases, where understanding the patient motivation, deciding/shaping long-term patient goals, and planning treatment are important, the therapists favored full human agency in reasoning (S1,S3). This can be interpreted as therapists' need to reconcile the subjective information from the patient ...  When the therapy shifts towards more concrete treatment and exercises, they increasingly accept (and prefer) system-led reasoning and execution, as long as they retain the ability of intervene. This pattern frames agency as situational rather than something attached to the human or the system.
...
Interestingly eventhough the therapists continuously mentioned their need for wanting agency, the scenario with full human agency was chosen the least. This however aligns with thier prefernce for less detail and only focus on higher level therapeutic decisions. 
...
1. The design should support phase-specific agency distribution & include all main phases of therapy
...
3. The design should prioritize low-detail interfaces with access to additional detail when needed. (for both input like instructions and output like recommendations, feedback and data ). Also more functional diagnotics instructions.. 
