...
In early phases, where understanding the patient motivation, deciding/shaping long-term patient goals, and planning treatment are important, the therapists favored full human agency in reasoning (S1,S3). This can be interpreted as therapists need for  When the therapy shifts towards more concrete treatment and exercises, they increasingly accept (and prefer) system-led reasoning and execution, as long as they retain the ability of intervene. This pattern frames agency as situational rather than something attached to the human or the system.
